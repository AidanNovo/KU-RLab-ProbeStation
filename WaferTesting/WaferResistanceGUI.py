...
class Window(Frame):
    ...
    def __init__(self, master=None, motorsPort='COM4', keithleyPort='COM13', emulate=False):
        ...
        self.WafnumEntry = Entry(self, textvariable=self.WafnumVar, width=35)
        
        #ROC number field
        self.ROCnum = "ROC_Number"
        self.ROCnumVar=StringVar() 
        self.ROCnumVar.set(str(self.ROCnum))
        ROCnumLabel = Label(self, text="ROC Number:")
        self.ROCnumEntry = Entry(self, textvariable=self.ROCnumVar, width=35)
        
        #Measurement description
        self.GroupType = "Resistor_Grouping"
        self.GroupTypeVar = StringVar()
        self.GroupTypeVar.set(str(self.GroupType))
        GroupTypeLabel = Label(self, text="Resistor Grouping:")
        self.GroupTypeEntry = Entry(self, textvariable=self.GroupTypeVar, width=35)
        
        #Bank num
        self.BankNum = "Bank_Number"
        self.BankNumVar = StringVar()
        self.BankNumVar.set(str(self.BankNum))
        BankNumLabel = Label(self, text="Bank Number:")
        self.BankNumEntry = Entry(self, textvariable=self.BankNumVar, width=35)
        
        #Resistor num
        self.ResNum = "Resistor_Number"
        self.ResNumVar = StringVar()
        self.ResNumVar.set(str(self.ResNum))
        ResNumLabel = Label(self, text="Resistor Number:")
        self.ResNumEntry = Entry(self, textvariable=self.ResNumVar, width=35)
        
        
        #Temp log
        self.TempNum = "Lab_Temperature"
        self.TempNumVar = StringVar()
        self.TempNumVar.set(str(self.TempNum))
        TempNumLabel = Label(self, text="Temperature: (F)")
        self.TempNumEntry = Entry(self, textvariable=self.TempNumVar, width=20)
        
        #Humidity log
        self.HumNum = "Lab_Humidity"
        self.HumNumVar = StringVar()
        self.HumNumVar.set(str(self.HumNum))
        HumNumLabel = Label(self, text="Humidity: (%)")
        self.HumNumEntry = Entry(self, textvariable=self.HumNumVar, width=20)        
        
        #N measurements
        self.nmeas = "N"
        self.nmeasVar = StringVar()
        self.nmeasVar.set(str(self.nmeas))
        nmeasLabel = Label(self, text="N Measurements:")
        self.nmeasEntry = Entry(self, textvariable=self.nmeasVar, width=20)
        
        #FileName
        self.ifile = "Input_File"
        self.ifileVar = StringVar()
        self.ifileVar.set(str(self.ifile))
        ifileLabel = Label(self, text="Input JSON file:")
        self.ifileEntry = Entry(self, textvariable=self.ifileVar, width=35)
        ...
        self.notesText = Text(self, height=5, width = 30)
       ...
       # getMinResistanceButton = Button(self, text="Get Min Resistance", width=15, height=2, command=self.getMinResistance)
        ...
        self.LoadCreateJsonButton=Button(self, text="Load/Create JSON file", width=20, height=2, command=self.LoadCreateJson)
        self.PerformMeasButton =Button(self, text="Perform Measurements", width=20, height=2, command=self.PerformMeasurements)
        self.PrintMeasButton  =Button(self, text="Print Summary", width=20, height=2, command=self.PrintMeasurements)
        self.WriteMeasButton  =Button(self, text="Write Measurements", width=20, height=2, command=self.WriteMeasurements)
        ...
        raiseFastButton.place(x=550, y=60)
        lowerFastButton.place(x=550, y=110)
        raiseButton.place(x=650, y=60)
        lowerButton.place(x=650, y=110)
...
##        self.resetLowerLimitZ.place(x=500,y=555)
        ...
        checkContactButton.place(x=575,y=350)
        ...
        WafnumLabel.place(x=30,y=300)
        self.WafnumEntry.place(x=30,y=325)
        ROCnumLabel.place(x=30,y=375)
        self.ROCnumEntry.place(x=30,y=400)
        GroupTypeLabel.place(x=30,y=450)
        self.GroupTypeEntry.place(x=30,y=475)
        BankNumLabel.place(x=30, y=525)
        self.BankNumEntry.place(x=30,y=550)
        ResNumLabel.place(x=30, y=600)
        self.ResNumEntry.place(x=30, y=625)
        ...
        ifileLabel.place(x=550, y=425)
        self.ifileEntry.place(x=550, y=450)
        
        self.LoadCreateJsonButton.place(x=550,y=475)
        self.PerformMeasButton.place(x=550, y=525)
        self.PrintMeasButton.place(x=550, y=575)
        self.WriteMeasButton.place(x=550, y=625)
        ...
        notesLabel.place(x=275,y=300)
        #self.notesEntry.place(x=575,y=375) 
        self.notesText.place(x=275,y=325)
        #runLabel.place(x=650,y=350)
        #self.runEntry.place(x=650,y=375)
        
        TempNumLabel.place(x=275,y=425)
        self.TempNumEntry.place(x=275,y=450)
        
        HumNumLabel.place(x=275,y=500)
        self.HumNumEntry.place(x=275,y=525)
        
        nmeasLabel.place(x=275,y=575)
        self.nmeasEntry.place(x=275,y=600)

        #self.NeedleTest.place(x=700,y=110)
    def LoadCreateJson(self):
        #do nothing 
        a=1
